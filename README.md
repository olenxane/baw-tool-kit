...
### 参数说明：
 ...
 - B站订阅下载工具：可以自动下载订阅的up猪的新视频，非常时候周末回家的内宿生使用，最好搭配一个cookie食用，可以使用Get cookies.txt LOCALLY浏览器扩展程序

当前的v2正式版功能更多更稳定，推荐使用
推荐通过源码运行，不想部署可以下载适用于x64Windows10/11系统的release
